    ...
    <>
      <div className="bg-[--white] border-4 border-[--blue-3] rounded-md w-2/3 m-auto mt-8 p-20">
        ...
        <p>
          ...
          agree to these Legal Terms prior to you using the Services.<br></br>
        ...
        <ol className="list-decimal">
          ...
          <li>
            ...
            please address your request to: support@linkedall.online.<br></br>
            ...
            visible on posting, reproducing, or displaying our Content.<br></br>
            We reserve all rights not expressly granted to you in and to the
            Services, Content, and Marks.<br></br>
            ...
            report you to the authorities.<br></br>
            <br></br>
          ...
          <li>
            ...
            Services (or any portion thereof).<br></br>
          </li>
          <br></br>
          <li>
          ...
          <li>
            ...
            if we have already requested or received payment.<br></br>
            ...
            dealers, resellers, or distributors.<br></br>
          </li>
          <br></br>
          <li>
            CANCELLATION<br></br>
            ...
            current paid term.<br></br>
            If you are unsatisfied with our Services, please email us at
            support@linkedall.online.<br></br>
          </li>
          <br></br>
          <li>
            ...
            <ul className="list-disc ml-8">
              ...
              <li> Selling lists of aggregated users</li>
              <li>
          ...
          <br></br>
          <li>
            USER GENERATED CONTRIBUTIONS<br></br>
            ...
            <ul className="list-disc ml-8">
              ...
              <li>
                ...
                child abuse, or otherwise intended to protect the health or
          ...
          <li>
            ...
            been asserted in your Contributions.<br></br>
            ...
            monitor your Contributions.<br></br>
          </li>
          <br></br>
          <li>
            GUIDELINES FOR REVIEWS<br></br>
            ...
            whether positive or negative.<br></br>
          ...
          <li>
            ...
            Policy, which is incorporated into these Terms of Service. Please be
            aware that the Services are hosted in the United Kingdom. If you
            ...
            disclosure that differ from applicable laws in the United Kingdom,
            then through your continued use of the Services, you are
            transferring your data to the United Kingdom, and you expressly
          ...
          <li>
            ...
            releases in connection therewith.<br></br>
          </li>
          <br></br>
          <li>
            GOVERNING LAW<br></br>
            ...
            of Contracts for the International Sales of Goods is expressly
            ...
            Jourpath Ltd. and yourself both agree to submit to the non-exclusive
            jurisdiction of the courts of United Kingdom, which means that you
            may make a claim to defend your consumer protection rights in
            regards to these Legal Terms in the United Kingdom.<br></br>
          </li>
          <br></br>
          <li>
            ...
            arbitration shall be Manchester, United Kingdom. The language of the
            proceedings shall be English. Applicable rules of substantive law
            shall be the law of the United Kingdom.<br></br>
            Restrictions<br></br>
            ...
            the general public or any other persons.<br></br>
            Exceptions to Informal Negotiations and Arbitration<br></br>
            ...
            jurisdiction of that court.<br></br>
          </li>
          <br></br>
          <li>
            CORRECTIONS<br></br>
          ...
          <br></br>
          <li>
            ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES<br></br>
            ...
            of credits by any means other than electronic means.<br></br>
          </li>
          <br></br>
          <li>
            MISCELLANEOUS<br></br>
          ...
          <li>
            ...
            at:<br></br>
            Jourpath Ltd.<br></br>
            SUITE A, 82 JAMES CARTER ROAD<br></br>
            Mildenhall, Suffolk IP28 7DE<br></br>
